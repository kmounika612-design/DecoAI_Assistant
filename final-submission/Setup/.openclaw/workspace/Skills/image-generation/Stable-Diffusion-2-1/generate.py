...
def generate(prompt, negative_prompt, seed, steps, guidance_scale, output_path):
    ...
    guidance_scale=7.5
    seed=10
    negative_prompt="cartoonish, blurry"
    prompt = "children's party decoration, colorful balloon pillars, themed backdrop, candy table, bright lighting, wide shot, photorealistic"
    steps=50
...
def main():
    ...
    parser.add_argument("--seed", type=int, default=4, help="Random seed for the initial latent")
