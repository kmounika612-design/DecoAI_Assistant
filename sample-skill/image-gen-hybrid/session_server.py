...
Start this process ONCE before running SD3.5_Tool.py:
    python Scripts/session_server.py [--model_dir <path>]

Architecture
------------
All five ONNX sessions are created at server startup and kept alive in memory.
...
Arguments
---------
  --model_dir   Directory containing the five *_qnn_ctx_fp32_io.onnx files.
...
MODELS = {
    ...
    "text_encoder_3": "text_encoder_3_qnn_ctx_fp32_io.onnx",
...
class SessionStore:
    ...
    def run_session(self, name: str, feeds: dict) -> list:
        ...
        Parameters
        ----------
        name  : one of 'text_encoder', 'text_encoder_2', 'text_encoder_3',
                'transformer', 'vae_decoder'
...
SERVER_PORT    = 50000
SERVER_AUTHKEY = b"sd35-ort-server"

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Persistent ORT session server for SD 3.5 medium"
    )
    parser.add_argument(
        "--model_dir",
