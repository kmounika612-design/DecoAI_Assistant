...
def generate_wrapper_onnx_file(
    ...
    # Pin IR version 10 and opset 22 — onnxruntime-qnn 1.21.0 only guarantees
    # support up to IR version 10 / opset 22, but onnx's helper.make_model()
    # defaults to whatever is bundled with the installed onnx package (IR 13,
    # opset 26 at the time of writing), which onnxruntime then refuses to load.
